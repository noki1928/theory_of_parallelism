...
![task1](images/table1.png)
*Время в зависимости от количества потоков и размера матрицы*
...
!![task3](images/task3_S.png)
*Ускорение от количества потоков*

!![task3](images/task3_T.png)
*Время выполнения от количества потоков*

!![task3](images/task3_E.png)
